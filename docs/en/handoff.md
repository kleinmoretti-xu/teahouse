...
Last updated: 2026-08-31 for **v0.54.0** (decision #290, group description and group announce; decision #289, ARM64 Wayland capture crash prevention). The application remains pinned to Electron 22.3.27, Node 16.17 main/preload, Chrome 108 renderer, and LAN-only runtime behavior.
...
| Area | State |
|---|---|
| Version | 0.54.0  group description and group announce (decision #290) |
