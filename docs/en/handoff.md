...
Last updated: 2026-08-10 for **v0.51.1** (decision #285, maintained English documentation and bilingual release metadata). The application remains pinned to Electron 22.3.27, Node 16.17 main/preload, Chrome 108 renderer, and LAN-only runtime behavior.
...
| Area | State |
|---|---|
| Version | 0.51.1 documentation release |
| Branch/release base | `main`, previous release tag `v0.51.0` |
